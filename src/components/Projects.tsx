  ...
  const projects = [
    {
      ...
      description: 'A modern e-commerce platform built with React, Node.js, and PostgreSQL. Features include user authentication, payment processing, and real-time inventory management.',
    ...
    },
    {
      ...
      description: 'A beautiful weather dashboard with location-based forecasts, interactive maps, and weather alerts. Built with modern web technologies.',
    ...
    },
    {
      ...
      description: 'A comprehensive analytics dashboard for social media metrics with real-time data visualization and automated reporting.',
    ...
    },
    {
      ...
      description: 'An intelligent chatbot with natural language processing capabilities, integrated with multiple messaging platforms.',
      image: 'https://images.pexels.com/photos/8386440/pexels-photo-8386440.jpeg?auto=compress&cs=tinysrgb&w=800',
      tags: ['Python', 'TensorFlow', 'NLP', 'REST API', 'Docker'],
      liveUrl: 'https://example.com',
      githubUrl: 'https://github.com',
      featured: false,
    },
